...
| `JIRA_TEST_LINK_TYPE`              | `Relates`                   | **Name** of the global issue link type (Admin → Issues → Issue linking), e.g. `Test` or `Relates`; not the inward/outward phrases shown on an issue (`is tested by` / `tests`). Verify with `GET /rest/api/2/issueLinkType` or `/rest/api/3/issueLinkType`.                                                                                                                                                                                                                                                                                                                                                       |
