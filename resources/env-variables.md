...
| `JIRA_TEST_ISSUE_CREATION_TYPE`       | `Test`                      | Exact issue **type name** for issues created as test cases in the test project (must exist in that project). Exposed as `default_jira_test_issue_creation_type` on `GET /api/config`.                                                                                                                                                                                                                                                                                           |
